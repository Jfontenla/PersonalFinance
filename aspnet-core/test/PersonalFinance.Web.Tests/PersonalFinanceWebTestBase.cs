...
using PersonalFinance.Models.TokenAuth;
...
{
    public abstract class PersonalFinanceWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static PersonalFinanceWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(PersonalFinanceWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<PersonalFinanceDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<PersonalFinanceDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<PersonalFinanceDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<PersonalFinanceDbContext, Task<T>> func)
        {
            T result;
